...
const AddUser = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        const data = await createUser({ username, email }).catch((err) => {
            console.log(err)
            toast.error(err)
        })
        ...
        <>
            ...
            <div className="grid min-h-screen place-items-center">
                <div className="w-11/12 p-12 bg-white sm:w-8/12 md:w-1/2 lg:w-5/12">
                    <h1 className="text-xl font-semibold">Hello Admin, <span className="font-normal">please fill the form to add New User</span></h1>
